/*
 ...
 Source Schema         : oss_admin

 Target Server Type    : MySQL
 Target Server Version : 50742 (5.7.42)
 File Encoding         : 65001

 Date: 15/09/2023 17:42:46
*/
...
CREATE TABLE `bi_file`  (
  ...
  INDEX `idx_name_version`(`name`, `version`) USING BTREE,
...
INSERT INTO `sys_config` VALUES (100, 'gofastdfs地址', 'bi.file.upload.host', '192.168.60.100', 'Y', 'admin', '2023-09-15 06:52:21', 'admin', '2023-09-15 06:52:54', '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 162 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统访问记录' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_menu` VALUES (2019, '文件列表', 2006, 1, '/system/file', '', 'C', '0', '1', 'system:file:view', '#', 'admin', '2023-09-15 06:39:05', '', NULL, '文件列表菜单');
...
) ENGINE = InnoDB AUTO_INCREMENT = 185 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2023-09-15 17:33:21', '2023-09-15 03:39:46', 'admin', '2023-09-15 03:39:46', '', '2023-09-15 09:33:20', '管理员');
...
INSERT INTO `sys_user` VALUES (101, 200, 'file_admin', 'file_admin', '00', '', '', '0', '', 'e1770d799a555888ab45b067770da4be', '18b15f', '0', '0', '127.0.0.1', '2023-09-15 17:13:16', NULL, 'admin', '2023-09-15 08:26:36', '', '2023-09-15 09:13:15', NULL);
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('8fcf2e97-dc17-454c-91b8-9e092a1f6aed', 'admin', '研发部门', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', 'on_line', '2023-09-15 16:32:36', '2023-09-15 17:33:21', 1800000);
INSERT INTO `sys_user_online` VALUES ('f45190dc-cc69-4cf1-b18f-4cad58be1105', 'admin', '研发部门', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', 'on_line', '2023-09-15 17:27:42', '2023-09-15 17:33:32', 1800000);
